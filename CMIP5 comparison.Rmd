...
2. Change these into anomalies: subtract 1981-2010 mean, divide by 1981-2010 sd.
...
sd <- apply(annual.sst[rownames(annual.sst) %in% 1981:2010,], 2, sd)
...
Something is wrong here...the 2013-2016 values are nearly 3, while in Walsh et al. they're ~2. Likewise, the early-1900s minima is nearly -4 in my calculation, but ~ -3 in Walsh et al.

I tried calculating montly anomalies and averaging these into anuual values, as well as re-running the above with ERSST4 (which is what Walsh et al. use). These don't produce results that are much more similar to the results in Walsh et al. Not sure why this is!

Need to figure that out. Going ahead with the comparison to preindustrial simulations.
